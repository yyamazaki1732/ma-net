  ...
  <main class="l-main">
    <div class="l-bg l-bg--white l-bg--bar">
      <div class="l-bg__inner">
        ...
        <p class="p-confirm-main__micro">ご入力内容を確認の上、「送信するボタン」で送信してください。</p>
        <!-- <?php echo do_shortcode( '[contact-form-7 id="58" title="確認画面"]' ); ?> -->
        <?php the_content(); ?>
        <!-- <script>
        document.addEventListener('wpcf7mailsent', function (event) {
        location = 'http://tokyo-d-plex.com/~22h_yamazaki/wordpress/contact-finish';
        }, false);
        </script> -->
      </div>
    </div>
